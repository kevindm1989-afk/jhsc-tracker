      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <header className="h-14 border-b bg-card flex items-center px-4 sticky top-0 z-10 gap-3">
          ...
          <div className="md:hidden flex-1 min-w-0">
            <p className="text-sm font-bold text-foreground leading-tight truncate">JHSC Advisor</p>
            <p className="text-[10px] text-muted-foreground font-mono uppercase tracking-wider">JHSC Advisor</p>
          </div>
